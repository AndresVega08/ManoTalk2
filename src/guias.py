...
class VideoPlayer(tk.Tk):
    def __init__(self, videos):
        ...
        self.iconbitmap(os.path.join(base_path, "resources\icon\MT2.0.ico"))
...
videos = [
    {"title": "Tu", "path": os.path.join(base_path, "resources/guia/Tu.mp4")},
    {"title": "Ustedes", "path": os.path.join(base_path, "resources/guia/Ustedes.mp4")},
    {"title": "Tu Nombre", "path": os.path.join(base_path, "resources/guia/Tu Nombre.mp4")},
    {"title": "Tu seña", "path": os.path.join(base_path, "resources/guia/Tu seña.mp4")},
    {"title": "Mi nombre", "path": os.path.join(base_path, "resources/guia/Mi nombre.mp4")},
    {"title": "Mi seña", "path": os.path.join(base_path, "resources/guia/Mi seña.mp4")},
    {"title": "Por favor", "path": os.path.join(base_path, "resources/guia/Por favor.mp4")},
    {"title": "Gracias", "path": os.path.join(base_path, "resources/guia/Gracias.mp4")},
    {"title": "Mio", "path": os.path.join(base_path, "resources/guia/Mio.mp4")},
    {"title": "El", "path": os.path.join(base_path, "resources/guia/El.mp4")},
    {"title": "Ella", "path": os.path.join(base_path, "resources/guia/Ella.mp4")},
    {"title": "Nosotros", "path": os.path.join(base_path, "resources/guia/Nosotros.mp4")},
    {"title": "Nuestro", "path": os.path.join(base_path, "resources/guia/Nuestro.mp4")},
    {"title": "Permiso", "path": os.path.join(base_path, "resources/guia/Permiso.mp4")},
    {"title": "Suyo", "path": os.path.join(base_path, "resources/guia/Suyo.mp4")},
    {"title": "Ellos", "path": os.path.join(base_path, "resources/guia/Ellos.mp4")},
